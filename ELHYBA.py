...
#حقوق المرعب @ALH_KAR - @ALH_KAR
# تطوير محمود المرعب اذا ما ذكرت مصدر بنحكح امك@ALH_KAR - @HLV_M 
ownerID = int("6670911845") #ايدي الادمن 
...
async def start_msg(app, message):
      reply_markup = ReplyKeyboardMarkup(
        [
          [
            KeyboardButton ("بـہـآيـروُجـہـرآمــہ"), KeyboardButton ("تــہـيـلـيـثــہـوُن")
          ],
          [KeyboardButton ("❤️‍🔥معلومات عن المطور 🤴🏻")]
        ],
...
async def generator_and_about(app,m):
    if m.text == "❤️‍🔥معلومات عن المطور 🤴🏻":
      text = ''
      text += "🐍 اللـغـة الـبـرمـجـيـة - بـايـثـون "
      text += f"\n🔥آصــہدآر بــہآيروُجــہرآم {v}"
      text += f"\n🌱 ❤️‍🔥اصـدار تــہـيـلـيـثــہـوُن❤️‍🔥{v2}"
      text += f"\n\n👤 مـطـور الـبـوت: @ALH_KAR"
      await m.reply(text, quote=True)

    if m.text == "بـہـآيـروُجـہـرآمــہ":
        rep = await m.reply(
        ...
        text += f'🔒 تم حفظ الجلسه في الرسايل المحفوظه بنجاح✓ انضم هنا HLV_M@'
